# ADR Index — Open-Agent

**Owner:** MoniGarr.com LLC
**Canonical Path:** `docs/ADR/`
**Guide:** [`../../MoniGarr_Engineering_Standards/Governance/ADR_GUIDE.md`](../../MoniGarr_Engineering_Standards/Governance/ADR_GUIDE.md)

| ID | Title | Status | Date |
|----|-------|--------|------|
| [ADR-0001](ADR-0001-openagent-contrib-isolation.md) | Open-Agent contrib isolation for upstream merge safety | Accepted | 2026-07-13 |
